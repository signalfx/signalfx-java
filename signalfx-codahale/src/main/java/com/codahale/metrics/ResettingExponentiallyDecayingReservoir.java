 ...
 *
 * <p>
 * This class was taken verbatim from the Dropwizard Metrics library. The only modification is
 * that {@link #getSnapshot()} clears the reservoir after the snapshot is taken.
 * </p>
 *
 ...
 */
public class ResettingExponentiallyDecayingReservoir implements Reservoir {
    ...
    /**
     * Creates a new {@link ResettingExponentiallyDecayingReservoir} of 1028 elements, which offers
     * a 99.9% confidence level with a 5% margin of error assuming a normal distribution, and an
     * alpha factor of 0.015, which heavily biases the reservoir to the past 5 minutes of
     * measurements.
     */
    public ResettingExponentiallyDecayingReservoir() {
     ...
     */
    public ResettingExponentiallyDecayingReservoir(int size, double alpha) {
    ...
    /**
     * Get a weighted snapshot of the values in this reservoir.
     *
     * The reservoir is reset once the snapshot is taken (all values are discarded).
     */
    @Override
